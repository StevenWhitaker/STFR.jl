...
function testone2()
    ...
    workspace = STFRBlochSimWorkspace(Spin{Float64}, STFRBlochSim{InstantaneousRF,InstantaneousRF,IdealSpoiling})
...
function testtwo2()
    ...
    s2 = Matrix{ComplexF64}(undef, length(Tfree), length(M0))
    workspace = STFRBlochSimWorkspace(SpinMC{Float64,2}, STFRBlochSim{InstantaneousRF,InstantaneousRF,IdealSpoiling})
    for j = 1:length(M0), i = 1:length(Tfree)
...
function testnonideal1()
    ...
    s2 = similar(s1)
    s3 = similar(s1)
    w1 = STFRBlochSimWorkspace(Spin{Float64}, STFRBlochSim{InstantaneousRF,InstantaneousRF,GradientSpoiling})
    w2 = STFRBlochSimWorkspace(Spin{Float64}, STFRBlochSim{InstantaneousRF,InstantaneousRF,RFSpoiling})
    w3 = STFRBlochSimWorkspace(Spin{Float64}, STFRBlochSim{InstantaneousRF,InstantaneousRF,RFandGradientSpoiling})
...
function testnonideal2()
    ...
    s2 = similar(s1)
    s3 = similar(s1)
    w1 = STFRBlochSimWorkspace(SpinMC{Float64,2}, STFRBlochSim{InstantaneousRF,InstantaneousRF,GradientSpoiling})
    w2 = STFRBlochSimWorkspace(SpinMC{Float64,2}, STFRBlochSim{InstantaneousRF,InstantaneousRF,RFSpoiling})
    w3 = STFRBlochSimWorkspace(SpinMC{Float64,2}, STFRBlochSim{InstantaneousRF,InstantaneousRF,RFandGradientSpoiling})
    spoil1 = GradientSpoiling(0, 0, 0, 2)
    spoil2 = RFSpoiling(2π)
    spoil3 = RFandGradientSpoiling(spoil1, spoil2)
    nTR = Val(2000)
...
function testnoninstant1()
    ...
    s2 = Matrix{ComplexF64}(undef, length(Tfree), length(M0))
    workspace = STFRBlochSimWorkspace(SpinMC{Float64,2}, STFRBlochSim{RF,RF,IdealSpoiling})
    for j = 1:length(M0), i = 1:length(Tfree)
